    ...
    <div className="mx-auto flex h-auto w-full flex-col gap-8 md:w-10/12">
      ...
      <div className="mx-auto flex w-full flex-col gap-2">
        ...
        >
          ...
          abortion provision. ADDIS AEMERO
        </div>
      </div>
      <TitlePara
        key="shibru"
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            In 2019, it appointed an Ethiopian celebrity physician named Seyoum
            Antonios as its Africa director. As the home of the African Union
            headquarters, Addis offers a gateway to a host of the continent’s
      ...
      <TitlePara
        ...
        para={
          <>
            {" "}
            More worrying are claims made by Monahan to her followers that some
            healthcare professionals in public hospitals and clinics are
            referring women seeking abortions to the Christian activists.
            Antonios and his wife also appear on Monahan’s YouTube channel where
            they are touted as ‘the original pro-life heroes in Ethiopia’. A
            practising physician at a private hospital in Addis and an assistant
            professor at a medical college, Antonios uses YouTube and TikTok to
            spread harmful pseudo-science, claiming that abortion causes
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            and his wife were not key figures in Africa’s anti-rights ecosystem,
            touring the continent and coordinating campaigns to halt any
            semblance of progress on SRHR. Multiple investigations have found
            links between FWI and several anti-LGBTQI+ bills in
            ...
            <Hyperlinks key="legislation" word="legislation." linkNumber={4} />
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-2">
        ...
        >
          ...
          (L) as its Africa director. Antonios is pictured here with FWI founder
          Sharon Slater (in purple) and Ugandan President Yoweri Museveni (in
          white) outside Uganda&apos;s State House in April 2023 during a
          conference on &apos;family values.&apos; NATIONAL RESISTANCE MOVEMENT
        </div>
      </div>
      <TitlePara
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            of the war in the northern Tigray region, including active fighting
            in many parts of the country, make issues like abortion an easy
            scapegoat for religious conservative
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            this culture of street protest, either pro or against. So you don’t
            get visible activity around abortion. It’s a very slow erosion, so I
            think one day we [could] wake up and a woman will find out she can
            no longer have an abortion. Research shows that religious language
            has recently been seeping into mainstream media, cultivating a
            platform for anti-abortion
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            practices like female genital mutilation persist in Ethiopia. In the
            Amhara region, 45 per cent of girls are married before the age of
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            threatening,’ she says. ‘I felt unsafe just for advocating for young
            people’s rights to SRHR information and services.’ Homosexuality is
            a criminal offence in Ethiopia and highly stigmatized.
          </>
        }
      />
      ...
      <TitlePara
        ...
        para={
          <>
            But not everyone is able to access these lifesaving services. Women
            living in Ethiopia’s conflict zones are particularly vulnerable to
            any rollbacks in abortion access. It has been widely documented that
            over the course of the two-year war in Tigray, troops fighting in
            support of the federal government committed widespread rape against
            Tigrayan women and
            ...
            Mekelle. ‘Most of the women who come to us are survivors of rape and
            gang rape,’ she says. ‘Even after the war, they are still repeatedly
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            where the procedure is free of
            <Hyperlinks key="charge" word="charge." linkNumber={13} />
            The rest take place in private clinics, predominantly run by
            international NGOs like MSI and FGAE. Unlike Desta, who experienced
            the devastating impact of abortion bans on women in the early 2000s,
            the next generation of doctors are not aware of this history. ‘They
            don’t know about that story, how women were dying of these
            complications, so they can easily be attracted to the opposition
            groups with their false and arrogant arguments,’ he says. Although
            doctors are legally obliged in Ethiopia to provide abortions if a
            woman meets the criteria for the procedure, cases of conscientious
            objection are not uncommon. Doctors who provide abortions also face
            stigma by their colleagues, says Aniley, who explains that
            healthcare workers talk of being insulted or accused of profiting
            from performing terminations, even though the procedure is free.{" "}
          </>
        }
      />
      <div className="mx-auto flex w-full flex-col gap-2">
        ...
        >
          ...
          of Ethiopia&apos;s family planning budget. ADDIS AEMERO
        </div>
      </div>
      <TitlePara
        key="fickle funding"
        ...
        para={
          <>
            ...
            not impacting the provision of safe abortion care in their clinics,
            funding is a more pressing worry. Foreign donors, including the
            United States, account for 70 per cent of Ethiopia’s family planning
            budget, making the country highly susceptible to
            <Hyperlinks key="cuts" word="cuts." linkNumber={13} />
            When then-US President Donald Trump implemented the ‘global gag
            rule’ – a policy that prohibits foreign NGOs that receive US funding
            from providing abortion services – it was a major blow. FGAE and MSI
            refused to comply meaning millions of people lost access to services
            and the system faltered as a result of programmes
      ...
      <TitlePara
        ...
        para={
          <>
            ...
            rented room of a ‘pro-life’ taxi driver. As Teferra says: ‘Ethiopian
            women are losing our rights left, right and centre as it is. Losing
            this would be such a terrible mistake, not just for women but for
      ...
      <div
        className={`${libre_baskerville.className} mx-auto w-full max-w-5xl text-2xl`}
      >
