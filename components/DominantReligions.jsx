...
const Page = () => {
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 md:gap-12 md:text-7xl">
      <TitlePara
      ...
      <div className="flex w-full flex-col gap-4">
        <section
          className={`${league_gothic.className} flex h-auto w-full flex-col items-center gap-16 border-yellow-600 max-sm:divide-y-2 max-sm:divide-yellow-600 md:aspect-video md:flex-row md:border-4 md:shadow-sm md:shadow-yellow-900`}
        >
          {/* //? orthodox */}
          <motion.div className="grid h-[50vh] w-full grid-rows-[10%_70%_20%]">
            ...
            <motion.div
              ...
              className="grid place-items-center text-[64px] font-bold text-red-500 md:text-7xl"
            >
              <span className="">
        ...
        <div
          className={`${aileron.className} w-full text-center text-sm text-gray-500 md:text-base`}
        >
          {/* Rest - 4% */}
          <span>
            Catholic - 0.7%, traditional - 0.6%, other 0.8%. Source:{" "}
            <a
              className="underline"
              href="https://www.cia.gov/the-world-factbook/countries/ethiopia/summaries/#people-and-society"
            >
              cia.gov
            </a>
          </span>
